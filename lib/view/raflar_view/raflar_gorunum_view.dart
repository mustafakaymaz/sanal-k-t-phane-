...
/*class RaflarGorunumView extends StatefulWidget {
  @override
  _RaflarGorunumViewState createState() => _RaflarGorunumViewState();
}

class _RaflarGorunumViewState extends State<RaflarGorunumView> {
  RafListesi rf = RafListesi();
